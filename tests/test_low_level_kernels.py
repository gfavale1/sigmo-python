...
def test_generate_csr_signatures_data(q, simple_graphs, sig_simple):
    result = sigmo.generate_csr_signatures(
        q,
        simple_graphs,
        sig_simple,
        "data",
...
def test_refine_csr_signatures_data(q, simple_graphs, sig_simple):
    ...
    result = sigmo.refine_csr_signatures(
        q,
        simple_graphs,
        sig_simple,
        "data",
...
def test_filter_candidates_exact_match_low_level(
    q,
    simple_graphs,
    sig_simple,
    cand_simple,
...
def test_join_candidates_exact_match_low_level(
    q,
    simple_graphs,
    sig_simple,
    cand_simple,
